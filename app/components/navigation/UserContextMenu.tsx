"use client";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from "@/app/lib/ui/dropdown-menu"
...
const UserContextMenu = ({ userSession, isCollapsed }: UserContextMenuProps) => {
    return (
        <DropdownMenu>
